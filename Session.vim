...
nnoremap ! :w :vert term ./a.out 
nnoremap ,t0 :0r ~/.vim/templ/templ0.cpp :7i	
map ,f :Ranger
...
vnoremap ,ss di''hpl
nnoremap ,ss viwa'bi'lel 
vnoremap ,dd di""hpl
nnoremap ,dd viwa"bi"lel 
map ,m :MRUToggle 
...
inoremap  diwi
inoremap ,ss viwa'bi'lela 
inoremap ,dd viwa"bi"lela 
map ¬ >
noremap ® H
vmap ÷ <Plug>NERDCommenterTogglegv
nmap ÷ <Plug>NERDCommenterToggle
omap ÷ <Plug>NERDCommenterToggle
map ˙ <
map ˚ +
nnoremap ‘ :set list lcs=tab:\ \  
nnoremap “ :set list lcs=tab:\¦\ 
map ∆ -
noremap ‰ J 
iabbr ustd using namespace std; 
iabbr umapii unordered_map<int, int> 
iabbr dint deque<int> 
iabbr qint queue<int> 
iabbr sint stack<int> 
iabbr pii pair<int, int> 
iabbr vit vector<int> 
iabbr AJD Ahish Jayant Deshpande
iabbr iiithe International Institute of Information Technology, Hyderabad
iabbr @@ ahishjayant9009@gmail.com
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set runtimepath+=~/.vim/bundle/cosmic_latte
...
set runtimepath+=~/.vim/bundle/cosmic_latte/after
...
set runtimepath+=~/.vim/bundle/vim-autoformat/after
...
set runtimepath+=~/.vim/bundle/ranger.vim/after
...
exe 'vert 1resize ' . ((&columns * 123 + 92) / 185)
...
exe 'vert 4resize ' . ((&columns * 61 + 92) / 185)
exe '5resize ' . ((&lines * 19 + 20) / 41)
exe 'vert 5resize ' . ((&columns * 61 + 92) / 185)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("../shell/utils.h") | buffer ../shell/utils.h | else | edit ../shell/utils.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists("../shell/utils.c") | buffer ../shell/utils.c | else | edit ../shell/utils.c | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
tabnext 1
badd +1 utils.c
badd +25 ../shell/utils.c
badd +6 parse.c
badd +1 utils.h
badd +1 ../shell/utils.h
